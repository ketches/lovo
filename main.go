...
func main() {
	...
	mgr, err := ctrl.NewManager(ctrl.GetConfigOrDie(), ctrl.Options{
		...
		LeaderElectionID:       "lovo.ketches.cn",
		...
		// Use a cache that syncs every 5 minutes
		Cache: cache.Options{
			SyncPeriod: util.Ptr(time.Minute * 5),
		},
	})
	if err != nil {
	...
	if err = (&controller.PersistentVolumeClaimReconciler{
		...
		setupLog.Error(err, "unable to create controller", "controller", "PersistentVolumeClaimReconciler")
		os.Exit(1)
	}
